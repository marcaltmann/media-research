    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        through="archive.LocationReference", to="archive.location"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "person",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="archive.person"
                    ),
                ),
                (
                    "resource",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="archive.ResourceInvolvement", to="archive.person"
            ),
        ),
        migrations.CreateModel(
            name="TopicReference",
            fields=[
                ...
                (
                    "topic",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="archive.topic"
                    ),
                ),
            ],
        ),
        migrations.AddField(
            ...
            name="topics",
            field=models.ManyToManyField(
                through="archive.TopicReference", to="archive.topic"
            ),
        ),
        migrations.CreateModel(
            name="Transcript",
